...
def calculate_recipients
  ...
  # map goes through each email and returns new array
  # if email of subscribers matches email of unsubscribed, do not put that email in the new array

  SUBSCRIBERS.map do |email|
    if email != UNSUBSCRIBED[0]
      email
    end
  end
end
